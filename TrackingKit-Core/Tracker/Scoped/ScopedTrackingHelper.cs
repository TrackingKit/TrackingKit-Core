...
namespace Tracking
{
    ...
    internal static class ScopedTrackingHelper
    {
        ...
        public static bool RawPropertyExists(TrackerStorage storage, string propertyName, int minTick, int maxTick, SearchMode searchMode, IReadOnlyTagFilter filter)
        {
        ...
        public static bool RawPropertyExists(TrackerStorage storage, string propertyName, int minTick, int maxTick, SearchMode searchMode)
        {
            CheckPropertyGeneralArguments(propertyName, minTick, maxTick, searchMode);
        ...
        private static bool RawPropertyExistsInternal(TrackerStorage storage, string propertyName, int minTick, int maxTick, SearchMode searchMode, Func<TaggedData, bool> shouldIncludePredicate)
        {
        ...
        public static bool RawExists(TrackerStorage storage, int minTick, int maxTick, SearchMode searchMode, IReadOnlyTagFilter filter)
        {
        ...
        public static bool RawExists(TrackerStorage storage, int minTick, int maxTick, SearchMode searchMode)
        {
            CheckGeneralArguments(minTick, maxTick, searchMode);
        ...
        private static bool RawExistsInternal(TrackerStorage storage, int minTick, int maxTick, SearchMode searchMode, Func<TaggedData, bool> shouldIncludePredicate)
        {
        ...
        public static int RawPropertyCount(TrackerStorage storage, string propertyName, int minTick, int maxTick, IReadOnlyTagFilter filter)
        {
        ...
        public static int RawPropertyCount(TrackerStorage storage, string propertyName, int minTick, int maxTick)
        {
            CheckPropertyGeneralArguments(propertyName, minTick, maxTick);
        ...
        private static int RawPropertyCountInternal(TrackerStorage storage, string propertyName, int minTick, int maxTick, Func<TaggedData, bool> shouldIncludePredicate)
        {
            int count = 0;
            var ticks = storage.GetTickKeys(propertyName).Where(t => t >= minTick && t <= maxTick).OrderBy(t => t).ToList();
        ...
        public static int RawCount(TrackerStorage storage, int minTick, int maxTick, IReadOnlyTagFilter filter)
        {
            bool ShouldInclude(TaggedData data)
            {
                return filter.ShouldIncludes(data.Tags);
        ...
        public static int RawCount(TrackerStorage storage, int minTick, int maxTick)
        {
            // Always include when no filter is provided
            bool ShouldIncludeAlways(TaggedData data) => true;
        ...
        private static int RawCountInternal(TrackerStorage storage, int minTick, int maxTick, Func<TaggedData, bool> shouldIncludePredicate)
        {
            int totalCount = 0;
            var allPropertyNames = storage.GetPropertyNamesKeys();
        ...
        public static bool TryGetRawLatestValue(TrackerStorage storage, string propertyName, SearchMode searchMode, out int foundTick, out (int Version, TaggedData Data)? output, int minTick, int maxTick, IReadOnlyTagFilter filter)
        {
            CheckPropertyGeneralArguments(propertyName, minTick, maxTick, searchMode);
        ...
        public static bool TryGetRawDetailedValues(TrackerStorage storage, string propertyName, SearchMode searchMode, out int foundTick, out IEnumerable<(int Version, TaggedData Data)> output, int minTick, int maxTick, IReadOnlyTagFilter filter)
        {
            CheckPropertyGeneralArguments(propertyName, minTick, maxTick, searchMode);
